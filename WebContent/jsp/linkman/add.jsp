...
<head>
<TITLE>
<s:property value="#linkman==null? '添加联系人' : '修改联系人'"/>
</TITLE> 
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人管理 &gt;<s:property value="#linkman==null? '添加联系人' : '修改联系人'"/> </TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						</TABLE>
						<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/LinkManAction_saveLinkMan" method=post>
