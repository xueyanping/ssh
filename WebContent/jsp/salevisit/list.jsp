									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#list.getList()" var="salevisit" >
												<TR
													...
													<TD>
															<!-- 没有传递参数,显示删除和修改操作 -->
														<a href="${pageContext.request.contextPath }/SaleVisitAction_edit?visit_id=<s:property value="#salevisit.visit_id" />">修改</a>
														&nbsp;&nbsp;
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B><s:property value="#list.totalCount" /> </B>]条记录,[<B><s:property value="#list.totalPage" /></B>]页
												...
												<select name="pageSize" onchange="changePageSize($('#pageSizeSelect option:selected').val())" id="pageSizeSelect" >
													<option value="3" <s:property value="#list.pageSize==3?'selected':''" /> >3</option>
													<option value="5" <s:property value="#list.pageSize==5?'selected':''" /> >5</option>
												</select>
												条
												[<A href="javaScript:void(0)" onclick="changePage(<s:property value='#list.currentPage-1' />)" >前一页</A>]
												<B><s:property value="#pageBean.currentPage" /></B>
												[<A href="javaScript:void(0)" onclick="changePage(<s:property value='#list.currentPage+1' />)"  >后一页</A>] 
												到
												<input type="text" size="3" id="page" name="page" value="<s:property value="#list.currentPage" />"  />
												页
