...
<head>
<TITLE>
<s:property value="#customer==null? '添加用户' : '修改用户'  "/>
</TITLE> 
...
<script type="text/javascript">
	...
	$(function(){
		...
		//参数1 dict_type_code 
		//参数2  将下拉选放入的标签的对应的标签id
		//参数3 下拉选的name属性
		//参数4 需要回显option所对应的 id
		/* loadSelect("006","level","cust_level",cust_level.dict_id);
		loadSelect("002","source","cust_source",cust_source.dict_id);
		loadSelect("001","industry","cust_industry",cust_industry.dict_id);  */
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：客户管理 &gt; <s:property value="#customer==null? '添加 客户'  : '修改客户 ' "/></TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
