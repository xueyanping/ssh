...
function seletCustomer(cust_id,cust_name){
	//alert(cust_name);
	/* alert(cust_id);
	alert(cust_name); */
								...
								<TD height=25>
									<FORM id="customerForm" name="customerForm"
										...
										<input type="hidden" name="pageSize" id="pageSizeInput"
											...
											<!-- 隐藏域.放置linkman/add.jsp传来的select参数-->
								...
								<TD>
									<TABLE id=grid
										...
										<TBODY>
											...
											<s:iterator value="#list.getList()" var="cust">
												<TR
													...
													<input type="button" value="选择" onclick="seletCustomer(<s:property value='#cust.cust_id' />,'<s:property value='#cust.cust_name' />')">												
													</s:if>
													<s:else>
													 <a
														href="${pageContext.request.contextPath }/CustomerAction_edit?cust_id=<s:property value='#cust.cust_id'/>">修改</a>
														&nbsp;&nbsp; <a
								...
								<TD><SPAN id=pagelink>
										<DIV
											...
											共[<B><s:property value="#list.getTotalCount()" /> </B>]条记录,[<B><s:property
												...
												<option value="3" <s:property value="#list.getPageSize()==3? 'selected' : ''"/>>3</option>
												<option value="5" <s:property value="#list.getPageSize()==5? 'selected' : ''"/>>5</option>
