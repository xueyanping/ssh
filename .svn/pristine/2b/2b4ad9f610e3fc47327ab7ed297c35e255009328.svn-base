					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访时间 ：</td>
								<td  >
									<INPUT class=textbox id="visit_time" type="text" readonly="readonly"
														style="WIDTH: 180px" maxLength=50 name="visit_time"  value="<s:property value="#saleVisit.visit_time_s" />" >
								</td>
							</TR>
							...
							<TR>
								...
								<td>下次拜访时间：</td>
								<td>
								<INPUT class=textbox id="visit_nexttime" readonly="readonly" type="text"
